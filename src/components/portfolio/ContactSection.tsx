...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const serviceId = process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID || 'service_ilaxx4p';
      const templateId = process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || 'A4LLvNMYO6auKVxnY7n5o';
      const publicKey = process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY || 'RDbRaOP9i6yzstap3';
      ...
      const result = await emailjs.send(
        ...
        templateId,
        {
          ...
          to_email: 'amareleine@gmail.com', // Your email
        },
        publicKey
      );
              ...
              {submitStatus === 'error' && (
                ...
                >
                  ...
                  <p className="text-red-600 text-left dark:text-red-500 text-sm mt-1">
                    Please try again or contact me directly at amareleine@gmail.com
                  </p>
                  {/* add a button to close the message */}
                  <button
                    onClick={() => setSubmitStatus('idle')}
